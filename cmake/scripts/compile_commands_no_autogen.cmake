...
# project name must be set via -DPROJECT_NAME
if(NOT PROJECT_NAME)
  message(FATAL_ERROR "missing required parameter: -DPROJECT_NAME")
endif()
...
foreach(_line IN LISTS _input_json_lines)
  ...
  elseif(_line MATCHES "},?")
    ...
    set(_in_block False)
    set(_block "${_block}\n${CMAKE_MATCH_0}\n")
    # if the input file contains ".../${PROJECT_NAME}_autogen/..." then the
    ...
    if(_block MATCHES ".*\"file\": \"[^\"]*/${PROJECT_NAME}_autogen/[^\"]*\"" OR
